...
@section('content')
<x-back-button-component route="backend.adbanner.index" />
{{ html()->form('PUT', route('backend.adbanner.update', $adbanner->id))
        ...
        <div class="row gy-3">
            <div class="col-md-12 col-xl-3 position-relative">
                ...
                <div class="mb-3 uploaded-image" id="selectedImageContainer1">
                    @if ($adbanner->file_url)
                        <img src="{{ $adbanner->file_url }}" class="img-fluid mb-2" style="max-width: 100px; max-height: 100px;">
                ...
                {{ html()->hidden('file_url')->id('file_url1')->value($adbanner->file_url) }}
                ...
                <div class="row gy-3">
                    <div class="col-md-6 col-lg-6">
                        <div class="mb-3">
                            ...
                            {{
                                html()->text('name', $adbanner->name)
                                    ->class('form-control')
                                    ->id('name')
                                    ->placeholder(__('placeholder.lbl_ads_name'))
                        ...
                        <div>
                            ...
                            <div class="d-flex justify-content-between align-items-center form-control">
                                ...
                                <div class="form-check form-switch">
                                    ...
                                    {{
                                        html()->checkbox('status', $adbanner->status)
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="mb-3">
                            {{ html()->label(__('messages.link') . ' <span class="text-danger">*</span>', 'name')->class('form-label')}}
                            {{ html()->text('link', $adbanner->link)
                                ->class('form-control')
                                ->id('link')
                                ->placeholder(__('placeholder.lbl_genre_link'))
                                ->attribute('required', 'required')
                            }}
                            @error('link')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <div class="invalid-feedback" id="name-error">Link field is required</div>
                        </div>
                    </div>
                </div>
            </div>
